...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin'); ?> — Sinel Hospitality</title>
...
<div class="min-h-screen flex">
    ...
    <aside class="w-64 shrink-0 bg-emerald-deep text-sage hidden md:flex flex-col">
        ...
        <nav class="flex-1 px-4 py-6 space-y-1">
            <a href="<?php echo e(route('admin.dashboard')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-sage/10 text-white' : 'text-sage/60 hover:text-sage hover:bg-sage/5'); ?> transition-colors">
            ...
            <a href="<?php echo e(route('admin.projects.index')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->routeIs('admin.projects.*') ? 'bg-sage/10 text-white' : 'text-sage/60 hover:text-sage hover:bg-sage/5'); ?> transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>
                Projects
            </a>
            <a href="<?php echo e(route('profile.edit')); ?>"
               class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium <?php echo e(request()->routeIs('profile.edit') ? 'bg-sage/10 text-white' : 'text-sage/60 hover:text-sage hover:bg-sage/5'); ?> transition-colors">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                Profile
            </a>
        </nav>
        <div class="px-4 py-6 border-t border-sage/10 space-y-1">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-sage/60 hover:text-sage hover:bg-sage/5 transition-colors">
    ...
    <div class="flex-1 min-w-0">
        <header class="md:hidden flex items-center justify-between px-5 py-4 bg-emerald-deep text-sage">
            <span class="font-semibold">Sinel Admin</span>
            <a href="<?php echo e(route('home')); ?>" class="text-sm text-sage/60">View Site</a>
        </header>
...
</html><?php /**PATH /home/cirqzhav/sinel/sinel_web/resources/views/layouts/admin.blade.php ENDPATH**/ ?>