<footer class="bg-emerald-deep text-sage mt-0">
    ...
    <div class="max-w-[1400px] mx-auto px-5 md:px-8 py-16 grid sm:grid-cols-2 lg:grid-cols-[1.2fr_0.8fr_0.8fr_1.2fr] gap-12">
        <div>
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-3 mb-5">
                <img src="<?php echo e(asset('sinel_logo.png')); ?>" alt="" class="h-10 w-auto brightness-0 invert opacity-90">
            </a>
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm text-sage/75">
                <li><a href="<?php echo e(route('home')); ?>#about" class="hover:text-sage transition-colors">About</a></li>
                <li><a href="<?php echo e(route('home')); ?>#solutions" class="hover:text-sage transition-colors">How we work</a></li>
                <li><a href="<?php echo e(route('home')); ?>#insights" class="hover:text-sage transition-colors">Houses we keep</a></li>
                <li><a href="<?php echo e(route('academy')); ?>" class="hover:text-sage transition-colors">Academy</a></li>
                <li><a href="<?php echo e(route('home')); ?>#contact" class="hover:text-sage transition-colors">Visit</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-3 text-sm text-sage/75">
                <li><a href="<?php echo e(route('home')); ?>#solutions" class="hover:text-sage transition-colors">Turnkey projects</a></li>
                <li><a href="<?php echo e(route('home')); ?>#solutions" class="hover:text-sage transition-colors">Management</a></li>
                <li><a href="<?php echo e(route('home')); ?>#sustainability" class="hover:text-sage transition-colors">Sustainability</a></li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-4 text-sm text-sage/75">
                <li>
                    ...
                    <a href="https://wa.me/256772902188" target="_blank" rel="noopener" class="block text-coral hover:text-sage transition-colors">WhatsApp</a>
                </li>
                <li>
                    ...
                    <a href="https://wa.me/256774058752" target="_blank" rel="noopener" class="block text-coral hover:text-sage transition-colors">WhatsApp</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="border-t border-sage/10">
        <div class="max-w-[1400px] mx-auto px-5 md:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs tracking-wide">
            <p class="text-sage/55">&copy; <?php echo e(now()->year); ?> Sinel Hospitality.</p>
            <p class="text-sage/80">
                Designed &amp; built by <a href="https://cirqco.com/" target="_blank" rel="noopener" class="text-coral font-medium tracking-[0.12em] uppercase hover:text-sage transition-colors">Cirqco Systems</a>
            </p>
            <p class="text-sage/50">Est. 2022 &middot; Kampala</p>
        </div>
    </div>
</footer>
<?php /**PATH D:\My Apps\sinel_web\sinel_web\resources\views/partials/footer.blade.php ENDPATH**/ ?>