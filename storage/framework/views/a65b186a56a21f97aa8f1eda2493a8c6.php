...
<section class="relative overflow-hidden min-h-[70vh] flex items-end">
    ...
    <div class="relative max-w-[1400px] mx-auto px-5 md:px-8 pt-28 pb-16 sm:pb-20">
        <a href="<?php echo e(route('home')); ?>#academy" class="inline-flex items-center gap-2 text-sm text-sage/70 hover:text-coral transition-colors mb-8">
            Back to home
        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\My Apps\sinel_web\sinel_web\resources\views/academy.blade.php ENDPATH**/ ?>